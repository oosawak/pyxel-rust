...
const PYXEL_WHEEL_PATH = "pyxel-2.7.9-cp38-abi3-emscripten_4_0_9_wasm32.whl";
const PYXEL_LOGO_PATH = ""; // Image not available in WASM
const TOUCH_TO_START_PATH = ""; // Image not available
const CLICK_TO_START_PATH = ""; // Image not available
const GAMEPAD_CROSS_PATH = ""; // Image not available
const GAMEPAD_BUTTON_PATH = ""; // Image not available
const GAMEPAD_MENU_PATH = ""; // Image not available
